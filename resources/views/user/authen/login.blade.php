...
@section('container') --}}
<head>
    <title>LOGIN LAYANAN INFORMASI PERMOHONAN</title>
</head>
 {{-- login boostrap --}}
 <!-- Font Awesome -->
...
<link rel="stylesheet" 
 ...
 <div class="container">
     <div class="row d-flex justify-content-center align-items-center h-100">
         ...
         <div class="col-10 col-md-4 col-lg-6 col-xl-4 offset-xl-8">
             ...
             <div class="card text-dark" style="border-radius: 1rem;">
                <div class="mb-md-2 mt-md-2 pb-2">
                 ...
                 <div class="card-body">    
                         ...
                         <h4 class="fw-bold mb-4 text-center">Masuk</h4>
                        <form action="/login/user" method="post">
                            @csrf
                            <div class="form-group">
                                <label class="form-label form-dark" for="nik">NIK</label>
                            <input type="nik" name="nik" id="nik" class="form-control @error ('nik') is-invalid @enderror" autofocus required value="{{ old('nik') }}"/>
                            @error('nik')
                            ...
                            <p class="mt-4">Belum Memiliki Akun? <a href="/register/user" class="text-black-50 fw-bold">Daftar
                                    Akun</a></p>
                        </form>
